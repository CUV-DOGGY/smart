    ...
    <>
      <form className="panel stack-form address-form" onSubmit={submit}>
        <div className="panel-title">
          <div>
            <h2>{initialValue ? '编辑地址' : '新增地址'}</h2>
            <p>文字无法精确定位时请使用地图选点</p>
          </div>
        ...
        <label>
          ...
          <textarea
            ...
            onChange={change('detail_address')}
          />
        </label>
        <button
          type="button"
        ...
        >
          ⌖{' '}
          {form.longitude != null
            ? `已选点 ${form.longitude.toFixed(5)}, ${form.latitude.toFixed(5)}`
            : '打开高德地图选点'}
        </button>
